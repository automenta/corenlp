...
public abstract class FeatureFactory<IN> implements Serializable {
    ...
    public static final Clique[] knownCliques = new Clique[]{cliqueC, cliqueCpC, cliqueCp2C, cliqueCp3C, cliqueCp4C, cliqueCp5C, cliqueCpCp2C, cliqueCpCp2Cp3C, cliqueCpCp2Cp3Cp4C, cliqueCpCp2Cp3Cp4Cp5C, cliqueCnC, cliqueCpCnC};
    ...
    @Deprecated public static List<Clique> getCliques(int maxLeft, int maxRight) {
    ...
    public static void getCliques(int maxLeft, int maxRight, Consumer<Clique> recv) {
        for (final Clique c : knownCliques) {
            if (-c.maxLeft() <= maxLeft && c.maxRight() <= maxRight) {
                recv.accept(c);
            }
        }
