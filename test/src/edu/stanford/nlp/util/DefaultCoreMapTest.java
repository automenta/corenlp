package src.edu.stanford.nlp.util;
...
/**
 * Test various operations of the DefaultCoreMap: equals, toString, etc.
 */
public class DefaultCoreMapTest extends TestCase {

  public void testCreate() {
    DefaultCoreMap foo = new DefaultCoreMap();
  ...
  public void testGetAndSet() {
    ...
    DefaultCoreMap f1 = new DefaultCoreMap();
    f1.set(CoreAnnotations.TextAnnotation.class, "f");
    paragraphs.add(f1);
    DefaultCoreMap f2 = new DefaultCoreMap();
  ...
  public void testSimpleEquals() {
    ...
    DefaultCoreMap bar = new DefaultCoreMap();
  ...
  public void testRemove() {
    ...
    // after removing all sorts of stuff, the original DefaultCoreMap
...
//  /**
//   * DefaultCoreMap should be able to handle loops in its annotations
//   * without blowing up
//   */
//  @Ignore
...
//    assertEquals(fh, bh);
//
//    DefaultCoreMap baz = new DefaultCoreMap();
...
//    DefaultCoreMap f3 = new DefaultCoreMap();
...
//
//    DefaultCoreMap biff = new DefaultCoreMap();
...
//    DefaultCoreMap f4 = new DefaultCoreMap();
